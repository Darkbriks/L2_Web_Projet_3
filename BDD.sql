...
INSERT INTO movies (title, type, release_date, synopsis, vu, image_path, time_duration, note, rating, trailer_path) VALUES
    ...
    ('Star Wars: Episode III - Revenge of the Sith', 0,'2005-05-19', 'Three years into the Clone Wars, the Jedi rescue Palpatine from Count Dooku. As Obi-Wan pursues a new threat, Anakin acts as a double agent between the Jedi Council and Palpatine and is lured into a sinister plan to rule the galaxy.', FALSE, 'Star_Wars_Episode_III_Revenge_of_the_Sith.jpg', 140,12,9,'https://www.youtube.com/embed/5UnjrG_N8hU?si=kYq0WIHD77XsIJwS'),
    ...
    ('Pokémon: The First Movie - Mewtwo Strikes Back', 0, '1998-07-18', 'Ash et ses amis doivent affronter Mewtwo, un Pokémon légendaire créé par la Team Rocket.', FALSE, 'Pokemon_Movie_1.jpg', '01:15:00', 6, 'https://www.youtube.com/embed/hX-NHafvY5I?si=Jd-bFebfIeGvg-lg', 9),-- 10
    ('Pokémon: The Movie 2000 - The Power of One', 0, '1999-07-17', 'Ash et ses amis doivent sauver le monde d une catastrophe causée par la capture des oiseaux légendaires.', FALSE, 'Pokemon_Movie_2.jpg', 75, 7, 'https://www.youtube.com/embed/JHDctBjGBuA?si=hyYRRV7OOitJDEO6', 9),
    ('Pokémon: The Movie 3 - Spell of the Unown', 0, '2000-07-08','Ash et ses amis doivent sauver une jeune fille nommée Molly de l emprise des Pokémon Unown.', FALSE, 'Pokemon_Movie_3.jpg', 82, 6, 'https://www.youtube.com/embed/SEqstQn0sag?si=X5ucHDI-JlZ2anf7', 8),
    ('Pokémon: The Movie 4Ever - Celebi: Voice of the Forest', 0, '2001-07-07','Ash et ses amis voyagent dans le temps pour sauver Celebi, un Pokémon légendaire.', FALSE, 'Pokemon_Movie_4.jpg', 73, 6, 'https://www.youtube.com/embed/9lES7wavO5E?si=uW7HqQ370Yb5dugf', 7),
    ('Pokémon Heroes: Latios and Latias', 0, '2002-07-13','Ash et ses amis doivent protéger la ville d Altomare des méchants qui veulent capturer les Pokémon légendaires Latios et Latias.', FALSE, 'Pokemon_Movie_5.jpg', 81, 6, 'https://www.youtube.com/embed/ZivTZFebZGY?si=-QU45WQWNvDkpk_j', 8);
