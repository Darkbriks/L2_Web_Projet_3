...
INSERT INTO movies (title, type, release_date, synopsis, vu, image_path, time_duration, note, rating, trailer_path) VALUES
    ('Star Wars: Episode I - The Phantom Menace', 0,'1999-05-19', 'Two Jedi escape a hostile blockade to find allies and come across a young boy who may bring balance to the Force, but the long dormant Sith resurface to claim their old glory.', TRUE, 'Star_Wars_Phantom_Menace_poster.jpg', 140,10,9,'https://www.youtube.com/watch?v=bD7bpG-zDJQ&list=PLYZVlJMKY1dJqti6ZcgLIzXsg0A0QWcqH&index=2'),
    ...
    ('Star Wars: Episode IV - A New Hope', 0,'1977-05-25', 'Luke Skywalker joins forces with a Jedi Knight, a cocky pilot, a Wookiee and two droids to save the galaxy from the Empire''s world-destroying battle station, while also attempting to rescue Princess Leia from the mysterious Darth Vader.', TRUE, 'newHope.jpeg', 140,13,1,'https://www.youtube.com/watch?v=vZ734NWnAHA&list=PLYZVlJMKY1dJqti6ZcgLIzXsg0A0QWcqH&index=23'),
    ...
    ('Pokémon: The Movie 2000 - The Power of One', 0, '1999-07-17', 'Ash et ses amis doivent sauver le monde d une catastrophe causée par la capture des oiseaux légendaires.', FALSE, 'Pokemon_Movie_2.jpg', 75, 7, 'https://www.youtube.com/watch?v=JHDctBjGBuA', 9),
    ('Pokémon: The Movie 3 - Spell of the Unown', 0, '2000-07-08','Ash et ses amis doivent sauver une jeune fille nommée Molly de l emprise des Pokémon Unown.', FALSE, 'Pokemon_Movie_3.jpg', 82, 6, 'https://www.youtube.com/watch?v=SEqstQn0sag', 8),
    ('Pokémon: The Movie 4Ever - Celebi: Voice of the Forest', 0, '2001-07-07','Ash et ses amis voyagent dans le temps pour sauver Celebi, un Pokémon légendaire.', FALSE, 'Pokemon_Movie_4.jpg', 73, 6, 'https://www.youtube.com/watch?v=9lES7wavO5E', 7),
    ('Pokémon Heroes: Latios and Latias', 0, '2002-07-13','Ash et ses amis doivent protéger la ville d Altomare des méchants qui veulent capturer les Pokémon légendaires Latios et Latias.', FALSE, 'Pokemon_Movie_5.jpg', 81, 6, 'https://www.youtube.com/watch?v=ZivTZFebZGY', 8);
