...
INSERT INTO movies (title, release_date, synopsis, vu, image_path, time_duration, note, rating) VALUES
    ...
    ('Star Wars: Episode IV - A New Hope', '1977-05-25', 'Luke Skywalker joins forces with a Jedi Knight, a cocky pilot, a Wookiee and two droids to save the galaxy from the Empire''s world-destroying battle station, while also attempting to rescue Princess Leia from the mysterious Darth Vader.', TRUE, 'Star_Wars_Episode_IV_A_New_Hope.jpg', 140,13,-9),
    ('Star Wars: Episode V - The Empire Strikes Back', '1980-05-21', 'After the Rebels are brutally overpowered by the Empire on the ice planet Hoth, Luke Skywalker begins Jedi training with Yoda, while his friends are pursued by Darth Vader.', TRUE, 'Star_Wars_Episode_V_The_Empire_Strikes_Back.jpg', 140,14,-9),
    ('Star Wars: Episode VI - Return of the Jedi', '1983-05-25', 'After a daring mission to rescue Han Solo from Jabba the Hutt, the Rebels dispatch to Endor to destroy the second Death Star. Meanwhile, Luke struggles to help Darth Vader back from the dark side without falling into the Emperor''s trap.', FALSE, 'Star_Wars_Episode_VI_Return_of_the_Jedi.jpg', 140,15,-9),
